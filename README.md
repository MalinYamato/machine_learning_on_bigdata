...
It is a layer on top of Martin Karlsons framework that adds machine learning, data mining, ai and mathematical staticstic capabilites to it. This instance of the framework runs with upgraded versions 3.2.2 of Spark, 3.5.0 of Jyputerlab and 3.8.4 of Python.
#### Malin Yamato 大和まりん
